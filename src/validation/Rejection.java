...
public class Rejection{ /*extends InserttoDb implements ValidationI*/
	...
	public void recordLevel(String server, String str, Customer customer,BufferedWriter bufferedwriter){
		...
		//Validity Check
		if (code && name && pinCode && record && flag && email) 
		{
	...
	public void fileLevel(String server, String str, Customer customer,BufferedWriter bufferedwriter) throws SQLException 
	{
		InsertDao dao = new InsertToDb();
		HashSet<String> set=dao.fetch_customer_code();
